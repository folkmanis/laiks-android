...
import com.folkmanis.laiks.data.implementations.NpUpdateServiceFirebase
...
abstract class ServiceModule {
    ...
    @Binds
    abstract fun provideNpUpdateService(impl: NpUpdateServiceFirebase): NpUpdateService
